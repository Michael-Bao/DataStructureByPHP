...
Class Code{
    ...
    public function __construct($verifyImageParams=array()) {
        //public function __construct($w=100,$h=50,$n=4,$imageType='png',$codeType=1){
        $this->width = $verifyImageParams['width'] ?? 100;
        $this->height = $verifyImageParams['height'] ?? 50;
        $this->numbers = $verifyImageParams['number'] ?? 4;
        $this->imageType = $verifyImageParams['imageType'] ?? 'png';
        $this->codeType = $verifyImageParams['codeType'] ?? 1;
